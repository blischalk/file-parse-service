...
(def p1 (row->person ["Doe" "Jane" "Female" "Blue" "11-28-1983"]))
...
(describe 'sort-by-field
  (it "sorts by last name decending"
    (should= [p4 p3 p1 p2] (sort-by-field records "lname")))
  (it "sorts by birth date ascending"
    (should= [p2 p3 p4 p1] (sort-by-field records "dob")))
  (it "sorts by gender (females before males), last name ascending"))
